...
public class ImageSupport {
	...
	// public static BufferedImage readFromFileAndResize(String filename, int X,
	// int Y) {
	...
	// public static BufferedImage readFromURLAndResize(URL url, int maxX, int
	// maxY) {
...
/*	public static boolean compareImages(BufferedImage image1, BufferedImage image2) {
		...
		for (int y = 0; y < 20; y++) {
			for (int x = 0; x < 20; x++) {
				...
				// System.out.println("Image comparison failed at
				// (x,y)=("+x+","+y+"). Expected "
				// + getPixel(image1,x,y) + ", was " + getPixel(image2,x,y) );
				//// return false;
				System.out.println(
						"(x,y)=(" + x + "," + y + ") " + getPixel(image1, x, y) + ", " + getPixel(image2, x, y));
