...
public class CodeGenVisitorTest implements ImageResources {
	...
	@Test
	/**
	 * The program in our language creates and displays a 512 x 512 image with
	 * all red pixels. Then it compares that to an image created by
	 * ImageSupport.makeConstantImage.
	 * 
	 * @throws Exception
	 */
	...
	@Test
	/**
	 * This is the same test case as before, but the assert statement has been
	 * updated to reflect the new instructions for where to put log statements
	 * in assignment 6.
	 * 
	 * @throws Exception
	 */
	...
	public void prog3() throws Exception {
		...
		String prog = "prog3";
		String input = prog + " boolean g;\n" + "g <- @ 0;\n" + "g -> SCREEN;\n" + "int h;\n" + "h <- @ 1;\n"
				+ "h -> SCREEN;";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = { "true", "55" }; // create command line
														// argument array to
														// initialize params,
														// none in this case
		runCode(prog, bytecode, commandLineArgs);
	...
	public void prog4() throws Exception {
		...
		show(input);
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = { "true", "34", "56" }; // create command
															// line argument
															// array to
															// initialize
															// params, none in
	...
	@Test
	// reads an image from the filename passed as command line argument and
	// displays it.
	// Compares the image output (and logged) from our language and compares
	// with the same image read directly from the file.
