...
public class ScannerTest {
    ...
    public void testEmpty() throws LexicalException {
        String input = "";  //The inpu t is the empty string.  This is legal
    ...
    @Test
    public void testKwDefX() throws LexicalException {
    ...
    public void testIntegerLiteral() throws LexicalException {
        String input = "000";  //The input is the empty string.  This is legal
        show(input);        //Display the input
        Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
        show(scanner);   //Display the Scanner
    }
    ...
    @Test
    public void testKWandIntegerLiteral() throws LexicalException {
        String input = "A 01230000";  //The input is the empty string.  This is legal
        show(input);        //Display the input
        Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
        show(scanner);   //Display the Scanner
    }
    ...
    public void testWhiteSpaces1() throws LexicalException {
        String input = "A\r\n01230000";  //The input is the empty string.  This is legal
        show(input);        //Display the input
        Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
        show(scanner);   //Display the Scanner
    }
    ...
    public void booleanLiteral() throws LexicalException {
        String input = "true false A\nDEF_X";  //The input is the empty string.  This is legal
        show(input);        //Display the input
        Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
        show(scanner);   //Display the Scanner
    }
    ...
    @Test
    public void operator1() throws LexicalException {
        String input = "+ = true false A 123\n06";  //The input is the empty string.  This is legal
        show(input);        //Display the input
        Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
        show(scanner);   //Display the Scanner
    }
    ...
    @Test
    public void separator1() throws LexicalException {
    ...
    @Test
    public void comments1() throws LexicalException {
        String input = "/45//hu\n\r\n\r\n\r\n/yasho";  //The input is the empty string.  This is legal
        show(input);        //Display the input
        Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
        show(scanner);   //Display the Scanner
    }
    ...
    @Test
    public void stringLiteral1() throws LexicalException {
        String input = "\"\b\"";  //The input is the empty string.  This is legal
        show(input);        //Display the input
        Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
        show(scanner);   //Display the Scanner
    }
	...
	*//**
	...
	@Test
	public void ValidStringLiteral1() throws LexicalException {
		String input = "\"abc\\\"\"";
		show(input);
		Scanner scanner = new Scanner(input).scan();
		show(scanner);
		checkNext(scanner, STRING_LITERAL, 0, 7, 1, 1);
        checkNext(scanner, EOF, 7, 0, 1, 8);
	}

	@Test
	public void InvalidStringLiteral1() throws LexicalException {
	...
	@Test
	public void InvalidStringLiteral2() throws LexicalException {
		String input = " \" \\\b \"";
		show(input);
		thrown.expect(LexicalException.class);  //Tell JUnit to expect a LexicalException
		try {
	...
	@Test
	public void ValidStringLiteral2() throws LexicalException {
		String input = "\" \\\\ \"";
		show(input);
		Scanner scanner = new Scanner(input).scan();
		show(scanner);
		checkNext(scanner, STRING_LITERAL, 0, 6, 1, 1);
        checkNext(scanner, EOF, 6, 0, 1, 7);
	}
	
	@Test
	public void ValidStringLiteral3() throws LexicalException {
		String input = "\" \\' \"";
		show(input);
		Scanner scanner = new Scanner(input).scan();
		show(scanner);
	...
	@Test
	public void ValidStringLiteral4() throws LexicalException {
		String input = "\" \\\' \"";
		show(input);
		Scanner scanner = new Scanner(input).scan();
		show(scanner);
